/* PROBLEM STATEMENT
Given a rectangular grid of positive and negative magnets, arrange 
them such that all the same poles are adjacent to each other. The magnets 
can be rotated but not moved from their positions.
*/
