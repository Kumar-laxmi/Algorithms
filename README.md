...
| 11.  | Cyclic Sort | [C++](https://github.com/Kumar-laxmi/Algorithms/blob/main/C%2B%2B/Sorting/cyclic_sort.cpp), [Java](https://github.com/Kumar-laxmi/Algorithms/blob/main/Java/Sorting/cyclic_sort.java) | Sorting |
...
| 20.  | Fractional Knapsack | [C](to be done once the PR is made) | Greedy Approach |
| 21.  | 0/1 Knapsack | [C](to be done once the PR is made), [C++](to be done once the PR is made) | Dynamic Programming |
| 22.  | Karatsuba Algorithm | [C++](to be done once the PR is made) | Divide-and-Conquer |
